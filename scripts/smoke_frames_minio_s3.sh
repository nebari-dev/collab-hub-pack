...
# quay.io, not Docker Hub: Docker Hub no longer serves minio/minio or minio/mc.
MINIO_IMAGE="${MINIO_IMAGE:-quay.io/minio/minio:RELEASE.2024-03-30T09-41-56Z}"
MC_IMAGE="${MC_IMAGE:-quay.io/minio/mc:RELEASE.2024-03-30T15-29-52Z}"
